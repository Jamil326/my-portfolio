  ...
  <div className="container">
    <div className="row align-items-center">
      ...
      <div className="col-lg-6 text-center mt-5 mt-lg-0">
        <img
          src="https://img.freepik.com/free-photo/programming-background-with-person-working-with-codes-computer_23-2150010125.jpg?semt=ais_incoming&w=740&q=80"
          alt="Web Design"
            ...
            <div className="col-md-4">
              <div className="card h-100 border-2 border-warning shadow rounded-4">
                <div className="card-body">
                  ...
                  <h3 className="fw-bold mt-2">₹4,999</h3>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm rounded-4">
                <div className="card-body">
                  ...
                  <h3 className="fw-bold mt-2">₹15,999</h3>
                  <p className="text-muted">
